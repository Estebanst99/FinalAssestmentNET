...
namespace FinalAssestment.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(EstebandatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var estebandatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EstebandatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
